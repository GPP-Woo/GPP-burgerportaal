...
Dit platform is samengesteld uit vier componenten. Eén van die componenten is het **GPP-Burgerportaal**, een webapplicatie waarop burgers de publicaties uit een GPP-registratiecomponent kunnen doorzoeken. Dit component omvat eveneens de sitemaps die nodig zijn om aan te kunnen sluiten op de landelijke Generieke Woo-Voorzieing (GWV) via de Woo-harvester (`DiWoo`). 
